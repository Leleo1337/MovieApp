            ...
            <div className="absolute top-1/2 left-1/2 w-[95%] max-w-[400px] -translate-1/2 rounded-2xl bg-secondary p-8 shadow-xl border border-gray-700 backdrop-blur-xl">
                    ...
                    <div>
                        <div className="space-y-6">
                            ...
                            <Link to="/main" className="block text-center w-full bg-button hover:bg-button/70 active:bg-button/50 transition duration-100 ease py-2 text-white rounded-sm cursor-pointer">Login </Link>
                            <p className="text-white">Don't have an account? <a href="#" className="text-button border-b-1">Sign-up</a> </p>
                        </div>
                    </div>
            </div>
        </>
